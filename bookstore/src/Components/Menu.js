...
function Menu(){
    ...
    return(
        <nav class="navbar fixed-top navbar-expand-sm navbar-light line pad ">
            <Link class="navbar-brand pad" to="/AdminBooks">Book Store</Link>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-collapse">☰</button> 
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item active"> <Link class="nav-link" to="/AdminBooks"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
  ...
  <path d="M2 1a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1zm11 0H3v14h3v-2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5V15h3z"/>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <Link class="dropdown-item" to="/AdminBooks">Edit Books</Link>
                        </div>
                    </li>
                    <li class="nav-item dropdown"> 
